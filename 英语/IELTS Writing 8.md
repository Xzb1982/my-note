...
直接写 compare就行，不要demonstrate +that+ compare，很冗杂

Generally , only petrol production ~~was~~ experienced a decline while others were showed an increase. the production of coal ~~was~~ remained the first place of energy production in France ,in 2005.

图表里面的pie可以直接表达信息，没必要被动语态

**In 1995, coal accounted for the largest share of energy production at 29.80%, followed closely by gas and petroleum, at 29.63% and 29.27% respectively. By 2005, coal production had risen slightly to 30.93%, while gas increased marginally to 30.31%, keeping its position as the second-largest source. Although petroleum was initially the third-largest source, its share dropped dramatically by almost ten percentage points to 19.55% in 2005, making it the least utilized energy source that year.**

==**单独用 account指的是视为；如果是 accounted for 就是占.....比例,而且一般用主动，不用被动**==

In 1995 , coal accounted for the biggest share of the ..... followed closely by ......, at ... and ... respectively

keep its position as ......

although ...... be in

~~By contrast, th~~e rest three energy production ~~were~~ experienced a dramatically change. The production of petrol ~~was d~~eclined sharply by 9.72% , from 29.27% to 19.55% .The figure for nuclear and other took up an obvious growth . Nuclear production ~~was ri~~sen by 3.70% from 6.40% to 10.10%. Similarly , an increase ~~was~~ taken place in other energy production which ~~was i~~ncreased by 4.20% from 4.90% to 9.10% .

**Regarding the remaining two categories, both started with relatively small shares in 1995.Nuclear energy stood at 6.40%, while other energy sources accounted for 4.90%. By 2005, both had experienced substantial growth: nuclear production more than doubled to 10.10%, and other energy sources nearly doubled to 9.10%. Despite these increases, they remained the two smallest contributors to France's energy mix.**

substantial growth 实质性增长

Regarding 在....方面，你可以理解为 ： 对....来说
